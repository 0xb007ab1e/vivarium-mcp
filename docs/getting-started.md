...
You can also use a prebuilt, signed release image instead of building, at
`ghcr.io/0xb007ab1e/vivarium-worker:v0.9.0`. Building locally is fine for trying things out.
