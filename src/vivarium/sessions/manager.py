...
from vivarium.tools.schemas import SessionInfo
...
#: ADR-006/ADR-017). Mirrors :class:`vivarium.server.auth.NullAuthenticator`'s principal id; kept
...
class WorkerHandle(Protocol):
    ...
    The concrete implementation lives in :mod:`vivarium.ghidra`; the manager treats it
...
class WorkerPort(Protocol):
    ...
    A subset of :class:`vivarium.ghidra.port.GhidraPort`; depending on the narrow interface keeps
