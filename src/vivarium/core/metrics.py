...
from vivarium.core.callgraph import AdjacencyMap, compute_analysis_order
...
def compute_call_graph_metrics(
    ...
    *,
    ...
    SCC machinery as :func:`vivarium.core.callgraph.compute_analysis_order`, so a single graph
