...
it raises a typed :class:`~vivarium.core.errors.GhidraMcpError` carrying a safe, redacted error
...
def validate_comment_text(text: str) -> str:
    ...
    Normalization reuses the single envelope chokepoint (:func:`vivarium.core.envelope.wrap`):
